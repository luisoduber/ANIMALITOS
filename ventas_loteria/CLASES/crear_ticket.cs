...
namespace ventas_loteria
{
    ...
    public class crear_ticket
    {
        ...
        int maxCar = 60, cortar;//Para una impresora ticketera que imprime a 40 columnas. La variable cortar cortara el texto cuando rebase el limte.
